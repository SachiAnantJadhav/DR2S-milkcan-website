...
import './aboutc.css'; // Include the CSS
...
const LandingPage = () => {
  return (
    ...
    <ul className="nav-links">
        ...
        <li><a href="/services">Order Now</a></li>
    ...
    <div className="landing-container">
      ...
      <div className="text-container">
        ...
        <div className="logo"><img src="./logo786.png" alt="Image 2" className="logoimg" />DR2S INDUSTRIES</div>
      ...
      <div className="images-container">
        <img src="/milkcan3.png" alt="Image 1" className="animated-image img1" />
      </div>    
    </div>
    <div classname="extra">
     ...
     <div className="info-section">
        <div className="info-content">
          ...
          <img src="/bottles.png" alt="Info" className="info-image" />
        </div>
      </div>
     ...
     <div className="info-section2">
        <div className="info-content2">
          ...
          <img src="/milkcan10.png" alt="Info" className="info-image2" />
        </div>
      </div>
